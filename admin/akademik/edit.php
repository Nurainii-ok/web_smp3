...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE prestasi_akademik SET prestasi='$prestasi', nama='$nama', tingkat='$tingkat', tanggal='$date', penyelenggara='$penyelenggara' WHERE id=$id";
...
<form method="POST" action="">
    ...
    Waktu: <input type="date" name="tanggal" value="<?php echo $row['tanggal']; ?>" required><br>
